...
int main(int argc, char *argv[])
{
    ...
    page=pdf_newpage(pdf,L,L,"glyph as text");
    ...
    pdf_fillstroke(pdf);
    pdf_endgroup(pdf);
    pdf_addgroup(pdf,page,g);

    page=pdf_newpage(pdf,L,L,"glyph as path");
    pdf_concat(pdf, 1,0,0,1,0,140);
    ...
    page=pdf_newpage(pdf,L,L,"transparency");
    pdf_concat(pdf, 1,0,0,1,0,140);
    pdf_setfill(pdf, 0.0,0.0,0.4);
    pdf_setfont(pdf, "Times-Roman");
    pdf_text(pdf, "g", 0, 512, 0, 0, 0);
    ...
    pdf_setfill(pdf, 1,1,0);
    pdf_setopacity(pdf,0.4);
    pdf_circle(pdf, 120,150,100);
    pdf_fillstroke(pdf);
    pdf_addgroup(pdf,page,g);
